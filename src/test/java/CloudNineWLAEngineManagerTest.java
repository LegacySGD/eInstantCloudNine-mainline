...
public class CloudNineWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CloudNineWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CloudNineIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CloudNineIW/InitOutcome.xml").getDocumentElement();
